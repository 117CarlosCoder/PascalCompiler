...
public class Multiplicacion extends Instruccion{
    ...
    public Multiplicacion(Instruccion operando1, Instruccion operando2, OperadoresAritmeticos operacion, int linea, int columna) {
        super(new Tipo(TipoDato.ENTERO), linea, columna);
        this.operando1 = operando1;
        this.operando2 = operando2;
    }
    
    public Object multiplicacion(Object op1, Object op2, Tipo tipo){
