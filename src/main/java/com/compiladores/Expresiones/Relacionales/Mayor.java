...
public class Mayor extends Instruccion{
    ...
    public Mayor(Instruccion operando1, Instruccion operando2, OperadoresRelacionales operacion, int linea, int columna) {
        super(new Tipo(TipoDato.ENTERO), linea, columna);
        this.operando1 = operando1;
        this.operando2 = operando2;
    }

    public Object mayorQue(Object op1, Object op2, Tipo tipo){
        ...
        switch (tipo1) {
            case TipoDato.ENTERO -> {
                switch (tipo2) {
                    ...
                    default -> {
                        return new Errores("SEMANTICO", "Mayor que erronea", this.linea, this.columna);
                    }
                }
            }
            case TipoDato.DECIMAL -> {
            ...
            case TipoDato.BOOLEANO -> {
                  switch (tipo2) {
                      case TipoDato.BOOLEANO -> {
                          tipo.setTipo(TipoDato.BOOLEANO);
                          int intOp1 = Boolean.parseBoolean(op1.toString()) ? 1 : 0;
                          int intOp2 = Boolean.parseBoolean(op2.toString()) ? 1 : 0;
    ...
    public Object mayorIgualQue(Object op1, Object op2, Tipo tipo){
        var tipo1 = this.operando1.tipo.getTipo();
        var tipo2 = this.operando2.tipo.getTipo();
        ...
        switch (tipo1) {
            case TipoDato.ENTERO -> {
                switch (tipo2) {
                    ...
                    default -> {
                        return new Errores("SEMANTICO", "Mayor Igual que erronea", this.linea, this.columna);
                    }
                }
            }
            case TipoDato.DECIMAL -> {
