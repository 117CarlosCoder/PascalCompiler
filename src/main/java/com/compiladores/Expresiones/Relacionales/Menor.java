...
public class Menor extends Instruccion{
    ...
    public Menor(Instruccion operando1, Instruccion operando2, OperadoresRelacionales operacion, int linea, int columna) {
        super(new Tipo(TipoDato.ENTERO), linea, columna);
        this.operando1 = operando1;
        this.operando2 = operando2;
    }
    
    public Object menorQue(Object op1, Object op2, Tipo tipo){
        ...
        switch (tipo1) {
            case TipoDato.ENTERO -> {
                switch (tipo2) {
                    ...
                    default -> {
                        return new Errores("SEMANTICO", "Menor que erronea", this.linea, this.columna);
                    }
                }
            }
            case TipoDato.DECIMAL -> {
    ...
    public Object menorIgualQue(Object op1, Object op2, Tipo tipo){
        var tipo1 = this.operando1.tipo.getTipo();
        var tipo2 = this.operando2.tipo.getTipo();
        ...
        switch (tipo1) {
            case TipoDato.ENTERO -> {
                switch (tipo2) {
                    ...
                    default -> {
                        return new Errores("SEMANTICO", "Menor Igual que erronea", this.linea, this.columna);
                    }
                }
            }
            case TipoDato.DECIMAL -> {
