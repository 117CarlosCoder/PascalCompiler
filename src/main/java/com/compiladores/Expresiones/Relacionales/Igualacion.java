...
public class Igualacion extends Instruccion{
    ...
    public Igualacion(Instruccion operando1, Instruccion operando2, OperadoresRelacionales operacion, int linea, int columna) {
        super(new Tipo(TipoDato.ENTERO), linea, columna);
        this.operando1 = operando1;
        this.operando2 = operando2;
    }
    
    public Object igualacion(Object op1, Object op2, Tipo tipo){
        ...
        switch (tipo1) {
            case TipoDato.ENTERO -> {
                switch (tipo2) {
                    ...
                    default -> {
                        return new Errores("SEMANTICO", "Igualacion erronea", this.linea, this.columna);
                    }
                }
            }
            case TipoDato.DECIMAL -> {
